...
WebUI.click(findTestObject('Admin/Jabatan/Page_HADIR/button_DeleteTabel'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Admin/Jabatan/Page_HADIR/button_Yes'), FailureHandling.STOP_ON_FAILURE)
