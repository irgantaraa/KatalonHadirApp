...
WebUI.setText(findTestObject('Admin/Jabatan/Page_HADIR/txtTambahkanNama'), 'Customer')
WebUI.setText(findTestObject('Admin/Jabatan/Page_HADIR/txtTambahkanLevel'), '')
...
String validationMessage = WebUI.executeJavaScript("return arguments[0].validationMessage;", Arrays.asList(WebUiCommonHelper.findWebElement(levelField, 5)))
