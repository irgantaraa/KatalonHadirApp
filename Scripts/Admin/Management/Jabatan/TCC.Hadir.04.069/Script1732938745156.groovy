...
WebUI.setText(findTestObject('Object Repository/Admin/Jabatan/Page_HADIR/input_Admin Hadir_search'), '1')
...
assert resultText.contains('1') : "Data edit failed. Expected '1' in search result but found: " + resultText
