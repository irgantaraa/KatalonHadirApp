...
WebUI.click(findTestObject('Admin/Cuti/025/Page_HADIR/button_clear'))

// Verify that the input field is cleared
String inputValue = WebUI.getAttribute(findTestObject('Object Repository/Admin/Cuti/022/Page_HADIR/input_Unit_job_departement'), 'value')
assert inputValue == '' : "Input field is not cleared!"
