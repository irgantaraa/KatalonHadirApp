...
WebUI.setText(findTestObject('Object Repository/Admin/IzinPulangCepatPage/002/Page_HADIR/input_Search_search'), 'Abc')
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Admin/IzinPulangCepatPage/002/Page_HADIR/pagination_DisplayedRows'), 10)
...
if (paginationElement != null) {
    ...
    if (paginationText == '0-0 of 0') {
        WebUI.comment('No search results found.')
    } else {
        WebUI.comment('Search results are displayed.')
        // Additional actions when results are present
    }
} else {
